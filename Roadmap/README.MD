...
The common calibration file has the correct calibration values that are to be applied to a specific set of data as defined by the "survey ID - data file name - channel ID" combination. 
